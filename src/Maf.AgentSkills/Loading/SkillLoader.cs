...
public sealed class SkillLoader
{
    ...
    /// <param name="options">The skills options for filtering.</param>
    /// <returns>The loaded skills state.</returns>
    public SkillsState LoadSkills(SkillsSettings settings, SkillsOptions options)
    {
        ...
        if (options.EnableProjectSkills)
        {
    ...
    public SkillMetadata? LoadSkill(string skillName, SkillsSettings settings)
    {
...
/// <param name="Size">The file size in bytes (only for files).</param>
