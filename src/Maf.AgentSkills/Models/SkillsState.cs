...
/// <summary>
/// Represents an incremental update to the skills state.
/// </summary>
public sealed class SkillsStateUpdate
{
    /// <summary>
    /// Gets or sets the skills that were added.
    /// </summary>
    public IReadOnlyList<SkillMetadata> AddedSkills { get; init; } = [];

    /// <summary>
    /// Gets or sets the skills that were removed.
    /// </summary>
    public IReadOnlyList<string> RemovedSkillNames { get; init; } = [];

    /// <summary>
    /// Gets or sets the skills that were modified.
    /// </summary>
    public IReadOnlyList<SkillMetadata> ModifiedSkills { get; init; } = [];

    /// <summary>
    /// Gets whether there are any changes in this update.
    /// </summary>
    public bool HasChanges => AddedSkills.Count > 0 || RemovedSkillNames.Count > 0 || ModifiedSkills.Count > 0;
}
